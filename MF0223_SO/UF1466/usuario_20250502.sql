...
-- Volcando estructura para tabla ifct310.usuarios
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `ruta_perfil` varchar(100) DEFAULT NULL COMMENT 'Para guardar las imagines de perfil de los usuario, si no mete ninguna se veria el fichero silueta',
  `cuota` decimal(10,2) DEFAULT NULL,
  `ultimoacceso` datetime DEFAULT current_timestamp(),
  `fecha_fincuota` datetime DEFAULT current_timestamp(),
